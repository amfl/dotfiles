...
# History settings pillaged from https://github.com/ohmyzsh/ohmyzsh/blob/master/lib/history.zsh
[ -z "$HISTFILE" ] && HISTFILE="$HOME/.zsh_history"
SAVEHIST=1000000  # Number of commands stored in history file
HISTSIZE=1100000  # Number of commands loaded into memory from history file
...
# Initiate autocompletion engine
